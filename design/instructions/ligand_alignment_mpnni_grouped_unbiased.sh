...
#SBATCH --qos=normal
#SBATCH --mem=5G                              # Total memory per task
#SBATCH --time=00:20:00                        # Time limit hrs:min:secu
#SBATCH --array=1-969                         # Array range: 900 jobs total
...
# Define Variables
# ------------------------------
PDB_DIR="/scratch/alpine/ryde3462/CDCA_design_normal/final_pass_score_repacked" # Directory with .pdb files
OUTPUT_BASE="/scratch/alpine/ryde3462/CDCA_design_normal/mpnn_output_1_unbiased"              # Base directory for LigandMPNN outputs
