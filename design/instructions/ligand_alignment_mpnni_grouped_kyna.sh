...
#SBATCH --array=1-500                   # Array range: 900 jobs total
...
# Define Variables
# ------------------------------
PDB_DIR="/scratch/alpine/ryde3462/xan_design/filtered_1" # Directory with .pdb files
OUTPUT_BASE="/scratch/alpine/ryde3462/xan_design/mpnn_output_2"              # Base directory for LigandMPNN outputs
