...
#SBATCH --array=1-912                         # Array range: 900 jobs total
...
# Define Variables
# ------------------------------
PDB_DIR="/scratch/alpine/ryde3462/UDCA_design_normal/filtered_1" # Directory with .pdb files
OUTPUT_BASE="/scratch/alpine/ryde3462/UDCA_design_normal/mpnn_output_2"              # Base directory for LigandMPNN outputs
...
for (( i=START_INDEX; i<=END_INDEX; i++ )); do
    ...
    python "${MODEL_SCRIPT}" \
        ...
        --batch_size 15 \
        --temperature 0.3 \
        --omit_AA_per_residue /projects/ryde3462/software/LigandMPNN/ligand_alignment_mpnn/scripts/instructions/LCA_omit_design_UDCA.json \
	--bias_AA_per_residue /projects/ryde3462/software/LigandMPNN/ligand_alignment_mpnn/scripts/instructions/LCA_bias_AA_per_residue_UDCA.json \
        --pack_side_chains 0 \
